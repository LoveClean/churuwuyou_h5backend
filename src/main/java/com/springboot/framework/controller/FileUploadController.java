...
import com.springboot.framework.bo.ImgUploadResponseBean;
...
public class FileUploadController {
    ...
    public ResponseBO<ImgUploadResponseBean> uploadImageEdit(@RequestParam("file") MultipartFile file, HttpServletRequest request) throws IOException {
        String filePath = obsService.upload(file);
        return ResponseUtil.success(new ImgUploadResponseBean(filePath));
    }
